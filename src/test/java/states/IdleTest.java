...
class IdleTest {
	...
	@Test
	@DisplayName("Singleton design pattern: initial state is the IdleTimer singleton instance")
	...
	@Test
	@DisplayName("Up event leaves state in IdleTimer when memTimer is zero")
	...
	@Test
	@DisplayName("Up event transitions to ActiveTimer when memTimer is non-zero")
	...
	@Test
	@DisplayName("Right event transitions to SetTimer state")
	void testRight() {
