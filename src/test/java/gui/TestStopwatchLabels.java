...
class TestStopwatchLabels extends TestGUIAbstract {
    ...
    @Test
	@DisplayName("Stopwatch UI shows correct mode labels and state name in reset state")
	void testStopwatch1() {
    ...
    @Test
	@DisplayName("Stopwatch UI shows correct mode labels and state name in running state")
	void testStopwatch2() {
    	c.left(); //simulate clicking on the left button
